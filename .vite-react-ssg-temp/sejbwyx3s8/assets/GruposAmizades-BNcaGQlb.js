...
import { UserPlus, TrendingUp, Users, Star, Clock } from "lucide-react";
...
const GruposAmizades = () => {
  ...
  useEffect(() => {
    const fetchGroups = async () => {
      try {
        const { data, error } = await supabase.from("groups").select("*").eq("status", "approved").eq("category", "Grupos do Telegram de Amizades").order("created_at", { ascending: false });
  ...
  const seo = categorySEO.amizades;
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-subtle", children: [
    ...
    /* @__PURE__ */ jsx(CategorySchema, { name: "Grupos do Telegram de Amizades", description: seo.description, url: `https://gruposdotelegram.org${seo.canonical}/` }),
    /* @__PURE__ */ jsx(BreadcrumbSchema, { items: [{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Amizades", url: `https://gruposdotelegram.org${seo.canonical}/` }] }),
    /* @__PURE__ */ jsx(Header, {}),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl mr-4", children: /* @__PURE__ */ jsx(UserPlus, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Grupos do Telegram de Amizades" }),
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-1", children: "Conecte-se com pessoas e construa amizades verdadeiras" })
            ] })
          ] }) }),
