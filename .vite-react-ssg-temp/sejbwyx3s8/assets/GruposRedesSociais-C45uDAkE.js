...
import { Share2, TrendingUp, Users, Star, Clock } from "lucide-react";
import "react";
...
const GruposRedesSociais = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-subtle", children: [
    ...
    /* @__PURE__ */ jsx(CategorySchema, { name: "Grupos do Telegram de Redes Sociais", description: categorySEO["redes-sociais"].description, url: `https://gruposdotelegram.org${categorySEO["redes-sociais"].canonical}/` }),
    /* @__PURE__ */ jsx(BreadcrumbSchema, { items: [{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Redes Sociais", url: `https://gruposdotelegram.org${categorySEO["redes-sociais"].canonical}/` }] }),
    /* @__PURE__ */ jsx(Header, {}),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl mr-4", children: /* @__PURE__ */ jsx(Share2, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Grupos do Telegram de Redes Sociais" }),
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-1", children: "Conecte-se e aprenda estratégias para redes sociais" })
            ] })
          ] }) }),
