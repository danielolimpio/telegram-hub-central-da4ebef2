...
import { Rainbow, TrendingUp, Users, Star, Clock } from "lucide-react";
import "react";
...
const GruposLGBTQIA = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-subtle", children: [
    /* @__PURE__ */ jsx(
      SEOHead,
      {
        title: categorySEO.lgbtqia.title,
        description: categorySEO.lgbtqia.description,
        canonical: categorySEO.lgbtqia.canonical
      }
    ),
    /* @__PURE__ */ jsx(CategorySchema, { name: "Grupos do Telegram de LGBTQIA+", description: categorySEO.lgbtqia.description, url: `https://gruposdotelegram.org${categorySEO.lgbtqia.canonical}/` }),
    /* @__PURE__ */ jsx(BreadcrumbSchema, { items: [{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "LGBTQIA+", url: `https://gruposdotelegram.org${categorySEO.lgbtqia.canonical}/` }] }),
    /* @__PURE__ */ jsx(Header, {}),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-br from-rainbow-start via-rainbow-middle to-rainbow-end rounded-xl mr-4", children: /* @__PURE__ */ jsx(Rainbow, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Grupos do Telegram de LGBTQIA+" }),
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-1", children: "Comunidade inclusiva, apoio e celebração diversidade" })
            ] })
          ] }) }),
