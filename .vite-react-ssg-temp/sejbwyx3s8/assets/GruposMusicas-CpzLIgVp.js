...
import { Music, TrendingUp, Users, Star, Clock } from "lucide-react";
import "react";
...
const GruposMusicas = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-subtle", children: [
    /* @__PURE__ */ jsx(
      SEOHead,
      {
        title: categorySEO.musicas.title,
        description: categorySEO.musicas.description,
        canonical: categorySEO.musicas.canonical
      }
    ),
    /* @__PURE__ */ jsx(CategorySchema, { name: "Grupos do Telegram de Músicas", description: categorySEO.musicas.description, url: `https://gruposdotelegram.org${categorySEO.musicas.canonical}/` }),
    /* @__PURE__ */ jsx(BreadcrumbSchema, { items: [{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Músicas", url: `https://gruposdotelegram.org${categorySEO.musicas.canonical}/` }] }),
    /* @__PURE__ */ jsx(Header, {}),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-br from-pink-500 to-rose-600 rounded-xl mr-4", children: /* @__PURE__ */ jsx(Music, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Grupos do Telegram de Músicas" }),
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-1", children: "Descubra novos artistas e compartilhe suas músicas favoritas" })
            ] })
          ] }) }),
