...
import { BookOpen, TrendingUp, Users, Star, Clock } from "lucide-react";
import "react";
...
const GruposLivros = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-subtle", children: [
    /* @__PURE__ */ jsx(
      SEOHead,
      {
        title: categorySEO.livros.title,
        description: categorySEO.livros.description,
        canonical: categorySEO.livros.canonical
      }
    ),
    /* @__PURE__ */ jsx(CategorySchema, { name: "Grupos do Telegram de Livros", description: categorySEO.livros.description, url: `https://gruposdotelegram.org${categorySEO.livros.canonical}/` }),
    /* @__PURE__ */ jsx(BreadcrumbSchema, { items: [{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Livros", url: `https://gruposdotelegram.org${categorySEO.livros.canonical}/` }] }),
    /* @__PURE__ */ jsx(Header, {}),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl mr-4", children: /* @__PURE__ */ jsx(BookOpen, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Grupos do Telegram de Livros" }),
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-1", children: "Descubra novos livros e compartilhe experiências literárias" })
            ] })
          ] }) }),
