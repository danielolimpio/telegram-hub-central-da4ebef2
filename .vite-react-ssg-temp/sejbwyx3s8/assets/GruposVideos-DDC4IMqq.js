...
import { Video, TrendingUp, Users, Star, Clock } from "lucide-react";
import "react";
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-br from-red-500 to-rose-600 rounded-xl mr-4", children: /* @__PURE__ */ jsx(Video, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Grupos do Telegram de Vídeos" }),
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-1", children: "Compartilhe e assista aos melhores vídeos" })
            ] })
          ] }) }),
