              ...
              <Card className="bg-gradient-to-br from-background to-purple-500/5 border-purple-500/10">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-xl sm:text-2xl font-bold text-foreground">
                      Explore os grupos do Telegram por tema
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
                  <p>
                    Nosso diretório organiza os melhores <strong className="text-foreground">grupos do Telegram</strong> em mais de 40 categorias — desde{" "}
                    <Link to="/grupos-telegram-amizades" className="text-telegram-blue hover:underline">amizades</Link>,{" "}
                    <Link to="/grupos-telegram-namoros" className="text-telegram-blue hover:underline">namoro</Link> e{" "}
                    <Link to="/grupos-telegram-encontros" className="text-telegram-blue hover:underline">encontros</Link>, passando por{" "}
                    <Link to="/grupos-telegram-games" className="text-telegram-blue hover:underline">games</Link>,{" "}
                    <Link to="/grupos-telegram-cinema" className="text-telegram-blue hover:underline">filmes e séries</Link>,{" "}
                    <Link to="/grupos-telegram-musicas" className="text-telegram-blue hover:underline">músicas</Link> e{" "}
                    <Link to="/grupos-telegram-livros" className="text-telegram-blue hover:underline">livros</Link>, até áreas mais objetivas como{" "}
                    <Link to="/grupos-telegram-empregos" className="text-telegram-blue hover:underline">empregos</Link>,{" "}
                    <Link to="/grupos-telegram-concursos" className="text-telegram-blue hover:underline">concursos</Link>,{" "}
                    <Link to="/grupos-telegram-investimentos" className="text-telegram-blue hover:underline">investimentos</Link>,{" "}
                    <Link to="/grupos-telegram-promocoes" className="text-telegram-blue hover:underline">promoções</Link> e{" "}
                    <Link to="/grupos-telegram-tecnologia" className="text-telegram-blue hover:underline">tecnologia</Link>.
                  </p>
                  <p>
                    Também mantemos comunidades regionais em{" "}
                    <Link to="/grupos-telegram-cidades" className="text-telegram-blue hover:underline">cidades brasileiras</Link>, grupos de{" "}
                    <Link to="/grupos-telegram-noticias" className="text-telegram-blue hover:underline">notícias</Link>,{" "}
                    <Link to="/grupos-telegram-religiao" className="text-telegram-blue hover:underline">religião</Link>,{" "}
                    <Link to="/grupos-telegram-esportes" className="text-telegram-blue hover:underline">esportes</Link>,{" "}
                    <Link to="/grupos-telegram-lgbtqia" className="text-telegram-blue hover:underline">LGBTQIA+</Link> e{" "}
                    <Link to="/grupos-telegram-liberais" className="text-telegram-blue hover:underline">liberais (+18)</Link>. Se procura um termo específico — como <em>canal do Telegram</em>, <em>bot</em>, <em>Stars</em>, <em>TON</em>, <em>Mini App</em>, <em>chat secreto</em> ou <em>supergrupo</em> — nosso{" "}
                    <Link to="/glossario" className="font-semibold text-telegram-blue hover:underline">Glossário do Telegram</Link> traz definições curtas e links diretos para cada categoria.
                  </p>
                  <div className="pt-2">
                    <Link
                      to="/glossario"
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-telegram-blue text-white font-medium hover:bg-telegram-blue/90 transition-colors"
                    >
                      Abrir Glossário completo A–Z →
                    </Link>
                  </div>
                </CardContent>
              </Card>
