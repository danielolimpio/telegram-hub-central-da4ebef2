...
const GruposEncontros = () => {
  ...
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <CategorySchema name="Grupos do Telegram de Encontros" description={seo.description} url={`https://gruposdotelegram.org${seo.canonical}/`} />
      <BreadcrumbSchema items={[{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Encontros", url: `https://gruposdotelegram.org${seo.canonical}/` }]} />
      <Header />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
          <div className="flex-1">
            ...
            <CategoryFAQ categoryKey="encontros" />
          </div>
