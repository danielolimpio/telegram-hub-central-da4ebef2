...
const GruposVendas = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <CategorySchema name="Grupos do Telegram de Vendas" description={seo.description} url={`https://gruposdotelegram.org${seo.canonical}/`} />
      <BreadcrumbSchema items={[{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Vendas", url: `https://gruposdotelegram.org${seo.canonical}/` }]} />
      <Header />
