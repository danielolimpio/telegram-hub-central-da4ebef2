...
const GruposEstilo = () => {
  ...
  const featuredGroups = [
    {
      title: "Estilo Brasil",
      description: "Moda, beleza e tendências estilo",
      members: 28560,
      avatar: "https://ui-avatars.com/api/?name=Estilo&background=0088cc&color=fff&size=128",
      category: "Estilo",
      isNew: true
    }
  ];
          ...
          <div className="flex-1">
            <div className="mb-8">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-gradient-to-br from-pink-600 to-fuchsia-700 rounded-xl mr-4">
                  <Sparkle className="w-8 h-8 text-white" />
                </div>
                <div>
                  <h1 className="text-3xl font-bold text-foreground">
                    Grupos do Telegram de Estilo
                  </h1>
                  <p className="text-muted-foreground mt-1">
                    Descubra tendências moda, beleza e lifestyle
                  </p>
                </div>
              </div>
            </div>
