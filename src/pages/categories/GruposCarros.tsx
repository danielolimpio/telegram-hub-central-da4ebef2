...
import { Users, TrendingUp, Star, Clock, Car } from "lucide-react";
...
const GruposCarros = () => {
    ...
    const fetchGroups = async () => {
      try {
        const { data, error } = await supabase
          ...
          .select("*")
          .eq("status", "approved")
          .eq("category", "Grupos do Telegram de Carros")
  ...
  const seo = categorySEO["carros"];

  return (
    <div className="min-h-screen bg-gradient-subtle">
      <SEOHead title={seo.title} description={seo.description} canonical={seo.canonical} />
      <CategorySchema name="Grupos do Telegram de Carros" description={seo.description} url={`https://gruposdotelegram.org${seo.canonical}/`} />
      <BreadcrumbSchema items={[{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Carros", url: `https://gruposdotelegram.org${seo.canonical}/` }]} />
      <Header />
          ...
          <div className="flex-1">
            <div className="mb-8">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-gradient-to-br from-red-500 to-orange-600 rounded-xl mr-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">
                    Comunidades sobre carros, automóveis e o universo automotivo
                  </p>
                </div>
              </div>
            </div>
            ...
            <CategoryFAQ categoryKey="carros" />
          </div>
