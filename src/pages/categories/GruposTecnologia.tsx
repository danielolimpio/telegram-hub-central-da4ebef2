...
import { Users, TrendingUp, Star, Clock, Cpu } from "lucide-react";
...
const GruposTecnologia = () => {
    ...
    const fetchGroups = async () => {
      try {
        const { data, error } = await supabase
          ...
          .select("*")
          .eq("status", "approved")
          .eq("category", "Grupos do Telegram de Tecnologia")
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <CategorySchema name="Grupos do Telegram de Tecnologia" description={seo.description} url={`https://gruposdotelegram.org${seo.canonical}/`} />
      <BreadcrumbSchema items={[{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Tecnologia", url: `https://gruposdotelegram.org${seo.canonical}/` }]} />
      <Header />
          ...
          <div className="flex-1">
            <div className="mb-8">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-gradient-to-br from-slate-600 to-gray-700 rounded-xl mr-4">
            ...
            <CategoryFAQ categoryKey="tecnologia" />
          </div>
...
export default GruposTecnologia;
