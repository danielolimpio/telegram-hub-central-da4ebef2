...
import { Users, TrendingUp, Star, Clock, Handshake } from "lucide-react";
...
const GruposNegocios = () => {
    ...
    const fetchGroups = async () => {
      try {
        const { data, error } = await supabase
          ...
          .select("*")
          .eq("status", "approved")
          .eq("category", "Grupos do Telegram de Negócios e Empreendedorismo")
  ...
  const seo = categorySEO["negocios"];

  return (
    <div className="min-h-screen bg-gradient-subtle">
      <SEOHead title={seo.title} description={seo.description} canonical={seo.canonical} />
      <CategorySchema name="Grupos do Telegram de Negócios e Empreendedorismo" description={seo.description} url={`https://gruposdotelegram.org${seo.canonical}/`} />
      <BreadcrumbSchema items={[{ name: "Início", url: "https://gruposdotelegram.org/" }, { name: "Negócios", url: `https://gruposdotelegram.org${seo.canonical}/` }]} />
      <Header />
          ...
          <div className="flex-1">
            <div className="mb-8">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl mr-4">
            ...
            <CategoryFAQ categoryKey="negocios" />
          </div>
